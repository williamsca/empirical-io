...
**a)** See attached code ("ps2_gmm_nest.m")

**b)** No. Identification in the random-coefficient logit model comes from variation in the choice set. With data on only one market (i.e., nationwide car sales for a single year), the random coefficient logit model is not identified.

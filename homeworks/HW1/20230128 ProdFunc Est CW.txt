...
# obtain predicted survival probabilities
...
# extract coefficients from first regression
...
fmla.op3 <- "LHSiii ~ a1*ldnpt + a2*ldrst + (phi - a1*ldnpt - a2*ldrst) + (phi - a1*ldnpt - a2*ldrst)^2 + P + P^2 + P*2*(phi - a1*ldnpt - a2*ldrst)"
